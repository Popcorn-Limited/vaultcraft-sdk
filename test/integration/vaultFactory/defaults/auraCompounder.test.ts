...
import { auraCompounder } from "../../../../src/vaultFactory/strategyDefaults/resolver/auraCompounder.js";
...
describe.concurrent("read-only", () => {
  ...
  test("auraCompounder() should return correct params and defaults", async () => {
    const result = await auraCompounder({ client: publicClient, address: "0x20a61B948E33879ce7F23e535CC7BAA3BC66c5a9" }); // R/DAI
    ...
    expect(result.default[0].value).toBe(97);
    expect(result.default[1].name).toBe("rewardTokens");
    expect(result.default[1].value).toBe(["0xba100000625a3754423978a60c9317c58a424e3D", "0xC0c293ce456fF0ED870ADd98a0828Dd4d2903DBF"]);
