...
import { VaultFees, WriteOptions, VaultOptions, VaultMetadata, AdapterOptions } from "./types.js";
...
describe("write-only", () => {
    ...
    // DEPLOY VAULT
    test("deployAdapterAndVault() should deploy an adapter and a vault with the given VaultOptions, VaultMetadata, AdapterOptions, and WriteOptions.", async () => {
        ...
        const metadata: VaultMetadata = {
            ...
            swapTokenAddresses: Array(8).fill(zeroAddress),
            swapAddress: zeroAddress,
            exchange: 0
        };
        const adapter: AdapterOptions = {
            asset: "0x6B175474E89094C44Da98b954EedeAC495271d0F",
            adapterData: "0x0000000000000000000000005dca0b3ed7594a6613c1a2acd367d56e1f74f92d",
            strategyData: "0x",
            initialDeposit: 0
        };
        const options: WriteOptions = {};

        const hash = await vaultFactory.deployAdapterAndVault(vault, metadata, adapter, options);
