...
const vaultController = new VaultController({address:vaultControllerAddress, publicClient, walletClient});
```
...
const txHash = vaultController.proposeVaultAdapters({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  adapters:["0x612465C8d6F1B2Bc85DF43224a8A3b5e04F634fc", "0xE48d33e869f874D6BEe3701beF22ae72c60A3b3c"],
...
```ts
const txHash = vaultController.changeVaultAdapters({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
...
const txHash = vaultController.proposeVaultFees({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  fees: [{ deposit: 0, withdrawal: 0, management: BigInt("1e16"), performance: BigInt("1e17") }, { deposit: 0, withdrawal: 0, management: 0, performance: BigInt("1e17") }],
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
```
...
```ts
const txHash = vaultController.changeVaultFees({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"], 
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
...
const txHash = vaultController.setVaultFeeRecipients({
   vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  recipients:["0xd8da6bf26964af9d7eed9e03e53415d37aa96045","0xd8da6bf26964af9d7eed9e03e53415d37aa96045"],
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
```
...
```ts
const txHash = vaultController.pauseVaults({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
...
```ts
const txHash = vaultController.unpauseVaults({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
...
const txHash = vaultController.setVaultQuitPeriods({
  vaults:["0x5d344226578DC100b2001DA251A4b154df58194f", "0x3D04Aade5388962C9A4f83B636a3a8ED63ea5b4D"],
  quitPeriods:[BigInt("86400"),BigInt("86400")],
  options:{ account: "0x7D51BABA56C2CA79e15eEc9ECc4E92d9c0a7dbeb" }
  });
// txHash = "0xb315ebed9539d8f46c1b3f95a538ff38db9716f83fd37789d2458f2b6c812bb6"
```